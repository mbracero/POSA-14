...
public class DownloadIntentService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        Intent ret = DownloadUtils.makeMessengerIntent(context, DownloadIntentService.class, handler, uri);
    ...
    protected void onHandleIntent (Intent intent) {
        ...
        String outputPath = DownloadUtils.downloadFile(getApplicationContext(), intent.getData());
        
        // Extract the Messenger.
        Messenger messenger = (Messenger)
                intent.getExtras().get(DownloadUtils.MESSENGER_KEY);
        
        // Send outputPath via messenger
